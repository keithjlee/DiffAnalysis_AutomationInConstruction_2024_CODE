...
GLMakie.activate!()
cstr_trace = hcat(res.cstr_history...)

series(cstr_trace, solid_color = (:black, .1))

# save data
# jldsave(datadir * "07_29_2024_gf_cobyla.jld2"; results = res)
# GHsave(model_opt, datadir * "07_29_2024_gf_cobyla.json")

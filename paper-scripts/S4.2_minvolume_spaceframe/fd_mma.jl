...
using AbstractDifferentiation, FiniteDifferences
...
# force objective and constraint function to use finite differencing 
obj_fd = abstractdiffy(OBJ, AbstractDifferentiation.FiniteDifferencesBackend(), x_init)
cstr_fd = abstractdiffy(CSTR, AbstractDifferentiation.FiniteDifferencesBackend(), x_init)
...
res = constrained_optimization(params, obj_fd, cstr_fd, alg, opts)
...
# jldsave(datadir * "07_29_2024_fd_mma.jld2"; results = res)
# GHsave(model_opt, datadir * "07_29_2024_fd_mma.json")